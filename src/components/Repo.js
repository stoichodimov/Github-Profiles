				...
				<div id="repos">
					<div className="repo-item">
						...
						<p className="description">
							It looks like the person you searched for either has no repositories or they do not exist.
						</p>
					</div>
				</div>
			);
							...
							<div className="repo-item">
								...
								<div className="bottom">
									<div className="language">
										<FontAwesomeIcon icon={faCode} className="img" />
										{repo.language}
									</div>
									<div className="star">
									...
									<div className="fork">
										<FontAwesomeIcon icon={faCodeBranch} className="img" />
										{repo.forks}
									</div>
								</div>
							</div>
